...
@Client.on_message(Filters.command(['pbio'], cmd) & Filters.me)
...
@Client.on_message(Filters.command(['ppic'], cmd) & Filters.me)
...
@Client.on_message(Filters.me & Filters.command(['lname']), cmd)
